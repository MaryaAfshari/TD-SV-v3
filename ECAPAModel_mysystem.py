...
class ECAPAModel(nn.Module):
    ...
    def enroll_network(self, enroll_list, enroll_path, path_save_model):
        ...
        for line in lines:
            ...
            for file in enroll_files:
                ...
                data = torch.FloatTensor(np.stack([audio], axis=0))
                with torch.no_grad():
    ...
    def test_network2(self, test_list, test_path, path_save_model, compute_eer=True):
        ...
        for test_file in test_files:
            ...
            audio_data.append(torch.FloatTensor(np.stack([audio], axis=0)))
        ...
        model_embeddings = torch.stack([enrollments[model_id] for model_id in model_ids])
